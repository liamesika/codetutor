        ...
        <article className="prose prose-invert max-w-none mb-16" dir="rtl">
          ...
          <section className="mb-10">
            ...
            <ul className="list-disc pr-6 text-[#D1D5DB] mt-2 space-y-2">
              <li><strong>BASIC</strong> (₪79, תשלום חד-פעמי) — גישה מלאה ל-10 ימי תוכן, 87+ שאלות תרגול, הרצת קוד, מעקב התקדמות ולוחות תוצאות.</li>
              <li><strong>PRO</strong> (₪149, תשלום חד-פעמי) — כל מה שב-BASIC, בתוספת AI Mentor אישי לאבחון שגיאות, רמזים מדורגים וניפוי באגים מודרך.</li>
            </ul>
          </section>
          ...
          <section className="mb-10">
            ...
            <ul className="list-disc pr-6 text-[#D1D5DB] mt-2 space-y-2">
              <li>ביטול מסלול BASIC (₪79): דמי ביטול של ₪3.95 (5% מ-₪79), החזר של ₪75.05.</li>
              <li>ביטול מסלול PRO (₪149): דמי ביטול של ₪7.45 (5% מ-₪149), החזר של ₪141.55.</li>
            </ul>
          </section>
