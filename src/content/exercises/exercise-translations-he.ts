...
export const exerciseTranslationsHe: Record<string, ExerciseTranslation> = {
  ...
  "declare-and-print-variables": {
    promptHe:
      "קראו שני מספרים שלמים מהקלט.\n\nהדפיסו בשורה הראשונה את הסכום שלהם, ובשורה השנייה את המכפלה שלהם.\n\nלדוגמה: אם הקלט הוא 3 ו-5, הפלט יהיה:\n8\n15",
    hintsHe: [
      "השתמשו ב-sc.nextInt() כדי לקרוא כל מספר שלם",
      "השתמשו ב-System.out.println() כדי להדפיס כל תוצאה בשורה נפרדת",
      "זכרו ש-+ מחבר מספרים ו-* מכפיל אותם",
    ],
  },
  "type-casting-int-to-double": {
    promptHe:
      "קראו שני מספרים שלמים מהקלט.\n\nהדפיסו בשורה הראשונה את תוצאת החילוק השלם (integer division), ובשורה השנייה את תוצאת החילוק העשרוני (double division) — מעוגל לשתי ספרות אחרי הנקודה.\n\nלדוגמה: עבור הקלט 7 ו-2 הפלט יהיה:\n3\n3.50\n\nשימו לב: חילוק בין שני int ב-Java נותן int (7/2=3), בעוד שהמרה ל-double לפני החילוק נותנת תוצאה עשרונית.",
    hintsHe: [
      "חילוק שלמים ב-Java חותך את החלק העשרוני: 7/2 = 3",
      "המירו אחד מהמשתנים ל-double לפני החילוק: (double) a / b",
      'השתמשו ב-System.out.printf("%.2f%n", value) כדי לעגל ל-2 ספרות',
    ],
  },
  "swap-two-variables": {
    promptHe:
      "קראו שני מספרים שלמים מהקלט. החליפו ביניהם והדפיסו אותם — כל אחד בשורה נפרדת.\n\nשורת הפלט הראשונה צריכה להכיל את ערך הקלט השני, והשורה השנייה את ערך הקלט הראשון.\n\nלדוגמה: עבור הקלט 3 ו-7 הפלט יהיה:\n7\n3\n\nרמז: תצטרכו משתנה עזר (temp) כדי לשמור ערך במהלך ההחלפה.",
    hintsHe: [
      "אתם צריכים משתנה זמני (temp) כדי לשמור ערך אחד במהלך ההחלפה",
      "שמרו את a ב-temp, אז שימו a = b, ואז b = temp",
      "הדפיסו את a ו-b אחרי שההחלפה הושלמה",
    ],
  },
  "expression-evaluation": {
    promptHe:
      "קראו שלושה מספרים שלמים a, b ו-c מהקלט.\n\nחשבו והדפיסו את תוצאת הביטוי: a² + 2*b - c\n(כלומר: a בריבוע ועוד פעמיים b פחות c).\n\nהדפיסו את התוצאה כמספר שלם אחד.\n\nלדוגמה: עבור a=3, b=4, c=2 — התוצאה היא 9 + 8 - 2 = 15.",
    hintsHe: [
      "a בריבוע זה a * a",
      "הנוסחה המלאה: a * a + 2 * b - c",
      "קראו שלושה מספרים עם sc.nextInt() והדפיסו את התוצאה",
    ],
  },
  ...
  "read-and-greet": {
    promptHe:
      'קראו שם של אדם (מילה אחת) מהקלט והדפיסו "Hello, <שם>!" כאשר <שם> מוחלף בקלט שקראתם.\n\nלדוגמה: אם הקלט הוא "Alice", הפלט יהיה: Hello, Alice!',
    hintsHe: [
      "השתמשו ב-sc.next() כדי לקרוא מילה אחת",
      'השתמשו בשרשור מחרוזות: "Hello, " + name + "!"',
      "וודאו שסימן הקריאה מופיע בסוף ללא רווח",
    ],
  },
  "read-full-line": {
    promptHe:
      "קראו מספר שלם n מהשורה הראשונה של הקלט, ואז קראו שורת טקסט מלאה מהשורה השנייה.\n\nהדפיסו את הטקסט n פעמים, כל פעם בשורה נפרדת.\n\nלדוגמה:\nקלט:\n2\nHello World\n\nפלט:\nHello World\nHello World",
    hintsHe: [
      "אחרי sc.nextInt() יש לקרוא את שארית השורה עם sc.nextLine()",
      "השתמשו בלולאת for כדי להדפיס את הטקסט n פעמים",
      "sc.nextLine() הראשון אחרי nextInt() קורא את הירידת שורה שנותרה",
    ],
  },
  "formatted-receipt": {
    promptHe:
      "קראו שם פריט (מילה אחת), כמות (מספר שלם), ומחיר ליחידה (מספר עשרוני) מהקלט — כל אחד בשורה נפרדת.\n\nהדפיסו קבלה בפורמט הבא:\nItem: <שם>\nQty: <כמות>\nTotal: $<סה\"כ>\n\nהסכום הכולל הוא כמות × מחיר, מעוגל ל-2 ספרות עשרוניות.",
    hintsHe: [
      "השתמשו ב-sc.next() לקריאת מילה, sc.nextInt() למספר שלם, sc.nextDouble() לעשרוני",
      "חשבו total = quantity * price",
      'השתמשו ב-System.out.printf("Total: $%.2f%n", total) לעיגול',
    ],
  },
  "multi-type-parser": {
    promptHe:
      "קראו מתוך שורה אחת בקלט (מופרדים ברווחים): מחרוזת (מילה), מספר שלם (int), מספר עשרוני (double), וערך בוליאני (boolean).\n\nהדפיסו כל ערך בשורה נפרדת עם תווית:\nWord: <מחרוזת>\nInteger: <int>\nDecimal: <double>\nBoolean: <boolean>\n\nהמספר העשרוני צריך להיות מוצג עם ספרה אחת אחרי הנקודה.",
    hintsHe: [
      "השתמשו ב-sc.next() למחרוזת, sc.nextInt() לשלם, sc.nextDouble() לעשרוני, sc.nextBoolean() לבוליאני",
      'השתמשו ב-printf("Decimal: %.1f%n", value) להצגת ספרה עשרונית אחת',
      "סדר הקריאה חייב להתאים לסדר הערכים בקלט",
    ],
  },
  ...
  "positive-negative-zero": {
    promptHe:
      'קראו מספר שלם מהקלט.\n\nהדפיסו "Positive" אם הוא גדול מאפס, "Negative" אם הוא קטן מאפס, או "Zero" אם הוא בדיוק אפס.',
    hintsHe: [
      "השתמשו ב-if / else if / else",
      "בדקו קודם אם המספר גדול מ-0, אחר כך קטן מ-0, ואז else עבור 0",
      "שימו לב לכתיב המדויק: Positive, Negative, Zero (אות גדולה ראשונה)",
    ],
  },
  "grade-calculator": {
    promptHe:
      'קראו ציון שלם (0-100) מהקלט. הדפיסו את הציון המילולי לפי הטבלה:\n\n• 90-100 → "A"\n• 80-89 → "B"\n• 70-79 → "C"\n• 60-69 → "D"\n• מתחת ל-60 → "F"\n\nלדוגמה: עבור ציון 85 הפלט יהיה B.',
    hintsHe: [
      "השתמשו בשרשרת if / else if",
      "בדקו מהטווח הגבוה לנמוך: >= 90 קודם, אז >= 80, וכו'",
      "אין צורך לבדוק את הגבול העליון אם בדקתם כבר בתנאי הקודם",
    ],
  },
  "day-of-week-switch": {
    promptHe:
      'קראו מספר שלם (1-7) מהקלט. הדפיסו את שם היום המתאים באנגלית באמצעות switch:\n\n1 = "Sunday", 2 = "Monday", 3 = "Tuesday", 4 = "Wednesday", 5 = "Thursday", 6 = "Friday", 7 = "Saturday"\n\nאם המספר לא בטווח 1-7, הדפיסו "Invalid".',
    hintsHe: [
      "השתמשו ב-switch(day) עם case לכל מספר",
      'אל תשכחו break אחרי כל case, ו-default להדפסת "Invalid"',
      "הפלט צריך להיות בדיוק כמו המילים באנגלית כולל אות גדולה ראשונה",
    ],
  },
  "triangle-type-classifier": {
    promptHe:
      'קראו שלושה מספרים שלמים המייצגים צלעות של משולש. קבעו והדפיסו את סוג המשולש:\n\n• "Equilateral" — אם כל שלוש הצלעות שוות\n• "Isosceles" — אם בדיוק שתי צלעות שוות\n• "Scalene" — אם אין צלעות שוות\n• "Not a triangle" — אם הצלעות לא יכולות ליצור משולש\n\nמשולש תקין: סכום כל שתי צלעות חייב להיות גדול מהצלע השלישית (a+b>c וגם a+c>b וגם b+c>a).',
    hintsHe: [
  ...
  "leap-year-checker": {
    promptHe:
      'קראו שנה (מספר שלם) מהקלט. קבעו אם היא שנה מעוברת והדפיסו "Leap year" או "Not a leap year".\n\nחוקי שנה מעוברת:\n• מתחלקת ב-4 וגם לא מתחלקת ב-100 → שנה מעוברת\n• מתחלקת ב-400 → שנה מעוברת\n• כל שאר המקרים → לא שנה מעוברת\n\nלדוגמה: 2024 → Leap year, 1900 → Not a leap year, 2000 → Leap year.',
    hintsHe: [
  ...
  "voting-eligibility": {
    promptHe:
      'קראו מספר שלם (גיל) ומחרוזת אזרחות ("yes" או "no") מהקלט, כל אחד בשורה נפרדת.\n\nאדם יכול להצביע אם הוא בן 18 ומעלה וגם אזרח. הדפיסו "Eligible" או "Not eligible".',
    hintsHe: [
      "קראו גיל עם sc.nextInt() ואזרחות עם sc.next()",
      'השתמשו בתנאי: age >= 18 && citizenship.equals("yes")',
      "זכרו להשתמש ב-.equals() להשוואת מחרוזות, לא ==",
    ],
  },
  "number-range-check": {
    promptHe:
      'קראו מספר שלם n מהקלט. בדקו אם n נמצא לפחות באחד מהטווחים הבאים:\n\n• 1 עד 10 (כולל)\n• 20 עד 30 (כולל)\n• 50 עד 60 (כולל)\n\nהדפיסו "In range" אם n נמצא באחד מהטווחים, אחרת "Out of range".',
    hintsHe: [
      "בדקו כל טווח בנפרד עם && (למשל: n >= 1 && n <= 10)",
      "חברו את שלושת התנאים עם || (או לוגי)",
      "אפשר לכתוב את כל התנאי בשורה אחת עם סוגריים",
    ],
  },
